...
### Removed
- BREAKING: Remove deprecated tool to migrate from AVI (Voyager Ingress) to ADI.
- BREAKING: Remove deprecated tool to set new storage version for Astarte / AVI CRs (used for Astarte Operator v22.11 migration).
